...
const T = {
  en: {
    ...
    roleDesc: {
      ...
      MANAGER:          'Head of Department — creates tasks for Customer Service using their department\'s forms, same as Staff. Requires a department assignment.',
  ...
  ar: {
    ...
    roleDesc: {
      ...
      MANAGER:          'رئيس القسم — ينشئ مهاماً لخدمة العملاء عبر نموذج قسمه تبعاً للقسم المُعيَّن له، مثله مثل الموظف. يشترط تعيين القسم.',
